        ...
        <main class="col ps-md-2 pt-2">
            ...
            <section class="products" >
               ...
               <div class="heading">
                  ...
                  <?php 
                     $select_category_name = mysqli_query($conn, "SELECT category_name FROM `category` where category_id= '$_GET[category_id]' LIMIT 1") or die('query failed');

                     if(mysqli_num_rows($select_category_name) > 0){
                        while($fetch_name = mysqli_fetch_assoc($select_category_name)){
                           echo 
                           "<h2> 
                              <p><a href='home.php'>Home</a> / Categories /" . $fetch_name['category_name'] . "<p>
                           </h2>";
                        }
                     }
                  ?>
               ...
               <?php 
                  $select_products = mysqli_query($conn, "SELECT * FROM `products` where category_id= '$_GET[category_id]' ") or die('query failed');
